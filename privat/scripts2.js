...
var tb_pathToImage = "http://www.almasoscuras.com/loadingAnimation.gif";
...
//Listas con rayas
$(document).ready(function(){
$('ul.tabla li:odd').addClass('par');
$('ul.tabla li:even').addClass('impar');
		});	

//Tabla con rayas
//$(document).ready(function(){
//$('table#tablapelis tr:odd').addClass('tablapar');
//$('table#tablapelis tr:even').addClass('tablaimpar');
		//});	
//esconder reseñas
$(document).ready(function(){
$('.terecomendamosmas').addClass("accessibility");
$('#vermasresenas').toggle(function(){	
									$('#vermasresenas').removeClass("flechitavermasresenas");
$('#vermasresenas').addClass("flechitavermasresenasdown");
$('#vermasresenas').text("Ver menos recomendaciones");		
$('.terecomendamosmas').removeClass("accessibility");
									},function(){
$('#vermasresenas').removeClass("flechitavermasresenasdown");
$('#vermasresenas').addClass("flechitavermasresenas");
$('#vermasresenas').text("Ver m\u00E1s recomendaciones");	
$('.terecomendamosmas').addClass("accessibility");
						  });
 						});
//Reset busqueda
$(document).ready(function(){
$('#cajabusqueda').attr({'value':'Busca en Almas...'});					   
$('#cajabusqueda').focus(function(){						   
					$(this).attr({'value':''});	  
									  });
						  });
...
//			if($(this).height()>colheight)colheight=$(this).height();}).css({height:colheight});
//		});	
