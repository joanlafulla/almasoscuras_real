...
/*
$HeadURL: https://textpattern.googlecode.com/svn/releases/4.4.1/source/textpattern/lib/txplib_head.php $
...
// -------------------------------------------------------------
	...
	$ch = curl_init();
	curl_setopt ($ch, CURLOPT_URL,$wp_gturl);
	curl_setopt ($ch, CURLOPT_TIMEOUT, 10);
	curl_setopt ($ch, CURLOPT_RETURNTRANSFER, 1);
	$wp_cntnt = curl_exec ($ch);
	curl_close($ch);}
